...
export default function HeroServices(){
  ...
  useEffect(() => {
    ...
    return(
      <>
      <section className="hero-3 w-screen h-screen relative flex items-center justify-center text-white" id="hero">
  {/* Image en arrière-plan */}
  <div 
    className="absolute inset-0 bg-cover bg-center h-screen  w-screen" 
    style={{ backgroundImage: "url('/assets/img/hero/hero-bg1_1.png')",
 ...
 <div className="relative z-10 text-center max-w-2xl px-6">
    <h1 className="text-4xl font-bold">Nos Catalogue de Services 2025</h1>
