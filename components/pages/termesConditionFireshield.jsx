      ...
      <section className="about-area space-top pb-425">
        <div className="container">
          <div className="max-w-3xl mx-auto p-6">
            ...
            <Paragraph>
              Ces termes et conditions définissent les règles d'utilisation de
              notre site web.
            </Paragraph>
            ...
            <Paragraph>
              L'utilisation du site doit se faire dans le respect des lois en
              vigueur et des présentes conditions.
            </Paragraph>
